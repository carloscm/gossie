...
func (p *CfDef) ReadField33(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err329 != nil { return thrift.NewTProtocolExceptionReadField(33, "bloom_filter_fp_chance", p.ThriftName(), err329); }
  ...
  if p.CompactionStrategyOptions != nil {
    if p.IsSetCompactionStrategyOptions() {
      ...
      for Miter332 := range p.CompactionStrategyOptions.Iter() {
        ...
        if err != nil { return thrift.NewTProtocolExceptionWriteField(0, "Kiter333", "", err); }
        err = oprot.WriteString(string(Viter334))
        if err != nil { return thrift.NewTProtocolExceptionWriteField(0, "Viter334", "", err); }
      }
      err = oprot.WriteMapEnd()
      if err != nil { return thrift.NewTProtocolExceptionWriteField(-1, "", "map", err); }
      err = oprot.WriteFieldEnd()
...
func (p *CfDef) WriteField33(oprot thrift.TProtocol) (err thrift.TProtocolException) {
  if p.IsSetBloomFilterFpChance() {
    ...
    if err != nil { return thrift.NewTProtocolExceptionWriteField(33, "bloom_filter_fp_chance", p.ThriftName(), err); }
...
func (p *CfDef) AttributeByFieldId(id int) interface{} {
  ...
  case 33: return p.BloomFilterFpChance
  }
  return nil
}
...
func (p *KsDef) ReadField1(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err339 != nil { return thrift.NewTProtocolExceptionReadField(1, "name", p.ThriftName(), err339); }
  p.Name = v338
  return err
}
...
func (p *KsDef) ReadField2(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err341 != nil { return thrift.NewTProtocolExceptionReadField(2, "strategy_class", p.ThriftName(), err341); }
...
func (p *KsDef) ReadField3(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  for _i348:= 0; _i348 < _size344; _i348++ {
    ...
    if err352 != nil { return thrift.NewTProtocolExceptionReadField(0, "_key349", "", err352); }
    _key349 := v351
    v353, err354 := iprot.ReadString()
    if err354 != nil { return thrift.NewTProtocolExceptionReadField(0, "_val350", "", err354); }
    _val350 := v353
...
func (p *KsDef) ReadField4(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err356 != nil { return thrift.NewTProtocolExceptionReadField(4, "replication_factor", p.ThriftName(), err356); }
...
func (p *KsDef) ReadField5(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  for _i363:= 0; _i363 < _size359; _i363++ {
    ...
    if err367 != nil { return thrift.NewTProtocolExceptionReadStruct("_elem364CfDef", err367); }
...
func (p *KsDef) ReadField6(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err369 != nil { return thrift.NewTProtocolExceptionReadField(6, "durable_writes", p.ThriftName(), err369); }
  ...
  if p.StrategyOptions != nil {
    if p.IsSetStrategyOptions() {
      ...
      for Miter370 := range p.StrategyOptions.Iter() {
        ...
        if err != nil { return thrift.NewTProtocolExceptionWriteField(0, "Kiter371", "", err); }
        err = oprot.WriteString(string(Viter372))
        if err != nil { return thrift.NewTProtocolExceptionWriteField(0, "Viter372", "", err); }
      }
      err = oprot.WriteMapEnd()
      if err != nil { return thrift.NewTProtocolExceptionWriteField(-1, "", "map", err); }
      err = oprot.WriteFieldEnd()
...
func (p *CqlRow) ReadField1(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err376 != nil { return thrift.NewTProtocolExceptionReadField(1, "key", p.ThriftName(), err376); }
  p.Key = v375
  return err
}
...
func (p *CqlRow) ReadField2(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  for _i383:= 0; _i383 < _size379; _i383++ {
    ...
    if err387 != nil { return thrift.NewTProtocolExceptionReadStruct("_elem384Column", err387); }
...
func (p *CqlMetadata) ReadField1(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  for _i396:= 0; _i396 < _size392; _i396++ {
    ...
    if err400 != nil { return thrift.NewTProtocolExceptionReadField(0, "_key397", "", err400); }
    _key397 := v399
    v401, err402 := iprot.ReadString()
    if err402 != nil { return thrift.NewTProtocolExceptionReadField(0, "_val398", "", err402); }
    _val398 := v401
...
func (p *CqlMetadata) ReadField2(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  for _i409:= 0; _i409 < _size405; _i409++ {
    ...
    if err413 != nil { return thrift.NewTProtocolExceptionReadField(0, "_key410", "", err413); }
    _key410 := v412
    v414, err415 := iprot.ReadString()
    if err415 != nil { return thrift.NewTProtocolExceptionReadField(0, "_val411", "", err415); }
    _val411 := v414
...
func (p *CqlMetadata) ReadField3(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err417 != nil { return thrift.NewTProtocolExceptionReadField(3, "default_name_type", p.ThriftName(), err417); }
...
func (p *CqlMetadata) ReadField4(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err419 != nil { return thrift.NewTProtocolExceptionReadField(4, "default_value_type", p.ThriftName(), err419); }
...
func (p *CqlMetadata) WriteField1(oprot thrift.TProtocol) (err thrift.TProtocolException) {
  if p.NameTypes != nil {
    ...
    for Miter420 := range p.NameTypes.Iter() {
      ...
      if err != nil { return thrift.NewTProtocolExceptionWriteField(0, "Kiter421", "", err); }
      err = oprot.WriteString(string(Viter422))
      if err != nil { return thrift.NewTProtocolExceptionWriteField(0, "Viter422", "", err); }
    }
    err = oprot.WriteMapEnd()
    if err != nil { return thrift.NewTProtocolExceptionWriteField(-1, "", "map", err); }
    err = oprot.WriteFieldEnd()
...
func (p *CqlMetadata) WriteField2(oprot thrift.TProtocol) (err thrift.TProtocolException) {
  if p.ValueTypes != nil {
    ...
    for Miter423 := range p.ValueTypes.Iter() {
      ...
      if err != nil { return thrift.NewTProtocolExceptionWriteField(0, "Viter425", "", err); }
    }
    err = oprot.WriteMapEnd()
    if err != nil { return thrift.NewTProtocolExceptionWriteField(-1, "", "map", err); }
    err = oprot.WriteFieldEnd()
...
func (p *CqlResult) ReadField1(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err427 != nil { return thrift.NewTProtocolExceptionReadField(1, "type", p.ThriftName(), err427); }
...
func (p *CqlResult) ReadField2(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  for _i434:= 0; _i434 < _size430; _i434++ {
    ...
    if err438 != nil { return thrift.NewTProtocolExceptionReadStruct("_elem435CqlRow", err438); }
...
func (p *CqlResult) ReadField3(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err440 != nil { return thrift.NewTProtocolExceptionReadField(3, "num", p.ThriftName(), err440); }
  p.Num = v439
  return err
}
...
func (p *CqlResult) ReadField4(iprot thrift.TProtocol) (err thrift.TProtocolException) {
  ...
  if err443 != nil { return thrift.NewTProtocolExceptionReadStruct("p.SchemaCqlMetadata", err443); }
  return err
}
