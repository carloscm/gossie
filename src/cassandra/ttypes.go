    ...
    if p.CompactionStrategyOptions != nil {
        if p.IsSetCompactionStrategyOptions() {
            ...
            for Miter330 := range p.CompactionStrategyOptions.Iter() {
                ...
                if err != nil {
                    return thrift.NewTProtocolExceptionWriteField(0, "Kiter331", "", err)
                }
                err = oprot.WriteString(string(Viter332))
                if err != nil {
                    return thrift.NewTProtocolExceptionWriteField(0, "Viter332", "", err)
                }
            }
            err = oprot.WriteMapEnd()
            if err != nil {
    ...
    if p.CompressionOptions != nil {
        if p.IsSetCompressionOptions() {
            ...
            for Miter333 := range p.CompressionOptions.Iter() {
                ...
                if err != nil {
                    return thrift.NewTProtocolExceptionWriteField(0, "Kiter334", "", err)
                }
                err = oprot.WriteString(string(Viter335))
                if err != nil {
                    return thrift.NewTProtocolExceptionWriteField(0, "Viter335", "", err)
                }
            }
            err = oprot.WriteMapEnd()
            if err != nil {
...
func (p *KsDef) ReadField1(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    if err337 != nil {
        return thrift.NewTProtocolExceptionReadField(1, "name", p.ThriftName(), err337)
    }
    p.Name = v336
    return err
}
...
func (p *KsDef) ReadField2(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    if err339 != nil {
        return thrift.NewTProtocolExceptionReadField(2, "strategy_class", p.ThriftName(), err339)
    }
...
func (p *KsDef) ReadField3(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    for _i346 := 0; _i346 < _size342; _i346++ {
        ...
        if err350 != nil {
            return thrift.NewTProtocolExceptionReadField(0, "_key347", "", err350)
        }
        _key347 := v349
        v351, err352 := iprot.ReadString()
        if err352 != nil {
            return thrift.NewTProtocolExceptionReadField(0, "_val348", "", err352)
        }
        _val348 := v351
...
func (p *KsDef) ReadField4(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    if err354 != nil {
        return thrift.NewTProtocolExceptionReadField(4, "replication_factor", p.ThriftName(), err354)
    }
...
func (p *KsDef) ReadField5(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    for _i361 := 0; _i361 < _size357; _i361++ {
        ...
        if err365 != nil {
            return thrift.NewTProtocolExceptionReadStruct("_elem362CfDef", err365)
        }
...
func (p *KsDef) ReadField6(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    if err367 != nil {
        return thrift.NewTProtocolExceptionReadField(6, "durable_writes", p.ThriftName(), err367)
    }
    ...
    if p.StrategyOptions != nil {
        if p.IsSetStrategyOptions() {
            ...
            for Miter368 := range p.StrategyOptions.Iter() {
                ...
                if err != nil {
                    return thrift.NewTProtocolExceptionWriteField(0, "Kiter369", "", err)
                }
                err = oprot.WriteString(string(Viter370))
                if err != nil {
                    return thrift.NewTProtocolExceptionWriteField(0, "Viter370", "", err)
                }
            }
            err = oprot.WriteMapEnd()
            if err != nil {
...
func (p *CqlRow) ReadField1(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    if err374 != nil {
        return thrift.NewTProtocolExceptionReadField(1, "key", p.ThriftName(), err374)
    }
    p.Key = v373
    return err
}
...
func (p *CqlRow) ReadField2(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    for _i381 := 0; _i381 < _size377; _i381++ {
        ...
        if err385 != nil {
            return thrift.NewTProtocolExceptionReadStruct("_elem382Column", err385)
        }
...
func (p *CqlMetadata) ReadField3(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    if err415 != nil {
        return thrift.NewTProtocolExceptionReadField(3, "default_name_type", p.ThriftName(), err415)
    }
...
func (p *CqlMetadata) ReadField4(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    if err417 != nil {
        return thrift.NewTProtocolExceptionReadField(4, "default_value_type", p.ThriftName(), err417)
    }
...
func (p *CqlMetadata) WriteField1(oprot thrift.TProtocol) (err thrift.TProtocolException) {
    if p.NameTypes != nil {
        ...
        for Miter418 := range p.NameTypes.Iter() {
            ...
            if err != nil {
                return thrift.NewTProtocolExceptionWriteField(0, "Kiter419", "", err)
            }
            err = oprot.WriteString(string(Viter420))
            if err != nil {
                return thrift.NewTProtocolExceptionWriteField(0, "Viter420", "", err)
            }
        }
        err = oprot.WriteMapEnd()
        if err != nil {
...
func (p *CqlMetadata) WriteField2(oprot thrift.TProtocol) (err thrift.TProtocolException) {
    if p.ValueTypes != nil {
        ...
        for Miter421 := range p.ValueTypes.Iter() {
            ...
            if err != nil {
                return thrift.NewTProtocolExceptionWriteField(0, "Kiter422", "", err)
            }
            err = oprot.WriteString(string(Viter423))
            if err != nil {
                return thrift.NewTProtocolExceptionWriteField(0, "Viter423", "", err)
            }
        }
        err = oprot.WriteMapEnd()
        if err != nil {
...
func (p *CqlResult) ReadField1(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    if err425 != nil {
        return thrift.NewTProtocolExceptionReadField(1, "type", p.ThriftName(), err425)
    }
...
func (p *CqlResult) ReadField2(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    for _i432 := 0; _i432 < _size428; _i432++ {
        ...
        if err436 != nil {
            return thrift.NewTProtocolExceptionReadStruct("_elem433CqlRow", err436)
        }
...
func (p *CqlResult) ReadField3(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    if err438 != nil {
        return thrift.NewTProtocolExceptionReadField(3, "num", p.ThriftName(), err438)
    }
    p.Num = v437
    return err
}
...
func (p *CqlResult) ReadField4(iprot thrift.TProtocol) (err thrift.TProtocolException) {
    ...
    if err441 != nil {
        return thrift.NewTProtocolExceptionReadStruct("p.SchemaCqlMetadata", err441)
    }
    return err
}
